!function() {
    ...
    function f(n) {
        return (n += "") === go || n[0] === vo ? vo + n : n
    }
    function s(n) {
        return (n += "")[0] === vo ? n.slice(1) : n
    }
    function h(n) {
    ...
    function k() {
        for (var n, t = to.event; n = t.sourceEvent; )
            t = n;
        return t
    }
    function N(n) {
    ...
    function D(n) {
        ...
        return function(e, r) {
            ...
            r ? (t.lastIndex = 0,
            t.test(i) || e.setAttribute("class", q(i + " " + n))) : e.setAttribute("class", q(i.replace(t, " ")))
        }
    }
    function P(n, t, e) {
        function r() {
    ...
    function W(e) {
        var r = ".dragsuppress-" + ++Ao
          , i = "click" + r
          , u = to.select(t(e)).on("touchmove" + r, S).on("dragstart" + r, S).on("selectstart" + r, S);
        if (null == Eo && (Eo = !("onselectstart"in e) && x(e.style, "userSelect")),
        Eo) {
            var o = n(e).style
              , a = o[Eo];
            o[Eo] = "none"
    ...
    function nn(n) {
        return n > 1 ? 0 : -1 > n ? Lo : Math.acos(n)
    }
    function tn(n) {
        return n > 1 ? Do : -1 > n ? -Do : Math.asin(n)
    }
    function en(n) {
    ...
    function an() {}
    function cn(n, t, e) {
        return this instanceof cn ? (this.h = +n,
        this.s = +t,
        void (this.l = +e)) : arguments.length < 2 ? n instanceof cn ? new cn(n.h,n.s,n.l) : _n("" + n, wn, cn) : new cn(n,t,e)
    }
    function ln(n, t, e) {
        function r(n) {
    ...
    function fn(n, t, e) {
        ...
        this.c = +t,
        void (this.l = +e)) : arguments.length < 2 ? n instanceof fn ? new fn(n.h,n.c,n.l) : n instanceof hn ? gn(n.l, n.a, n.b) : gn((n = Sn((n = to.rgb(n)).r, n.g, n.b)).l, n.a, n.b) : new fn(n,t,e)
    }
    function sn(n, t, e) {
        return isNaN(n) && (n = 0),
        isNaN(t) && (t = 0),
        new hn(e,Math.cos(n *= Po) * t,Math.sin(n) * t)
    }
    function hn(n, t, e) {
    ...
    function gn(n, t, e) {
        return n > 0 ? new fn(Math.atan2(e, t) * Uo,Math.sqrt(t * t + e * e),n) : new fn(NaN,NaN,n)
    }
    function vn(n) {
    ...
    function mn(n, t, e) {
        ...
        this.g = ~~t,
        void (this.b = ~~e)) : arguments.length < 2 ? n instanceof mn ? new mn(n.r,n.g,n.b) : _n("" + n, mn, ln) : new mn(n,t,e)
    }
    function Mn(n) {
    ...
    function _n(n, t, e) {
        ...
        return (u = Ko.get(n.toLowerCase())) ? t(u.r, u.g, u.b) : (null == n || "#" !== n.charAt(0) || isNaN(u = parseInt(n.slice(1), 16)) || (4 === n.length ? (o = (3840 & u) >> 4,
        o = o >> 4 | o,
        a = 240 & u,
        a = a >> 4 | a,
        c = 15 & u,
        c = c << 4 | c) : 7 === n.length && (o = (16711680 & u) >> 16,
        a = (65280 & u) >> 8,
        c = 255 & u)),
        t(o, a, c))
    }
    ...
    function Sn(n, t, e) {
        ...
        t = kn(t),
        e = kn(e);
        var r = dn((.4124564 * n + .3575761 * t + .1804375 * e) / $o)
          , i = dn((.2126729 * n + .7151522 * t + .072175 * e) / Bo)
          , u = dn((.0193339 * n + .119192 * t + .9503041 * e) / Wo);
    ...
    function Cn(n, t, e, r) {
        ...
        "onload"in c ? c.onload = c.onerror = i : c.onreadystatechange = function() {
            c.readyState > 3 && i()
        }
        ,
    ...
    function Ln() {
        var n = Tn()
          , t = Rn() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(ea),
        ea = setTimeout(Ln, t)),
        ta = 0) : (ta = 1,
        ia(Ln))
    }
    function Tn() {
        var n = Date.now();
        for (ra = Qo; ra; )
            n >= ra.t && (ra.f = ra.c(n - ra.t)),
            ra = ra.n;
        return n
    }
    function Rn() {
        for (var n, t = Qo, e = 1 / 0; t; )
            t.f ? t = n ? n.n = t.n : Qo = t.n : (t.t < e && (e = t.t),
            t = (n = t).n);
        return na = n,
        e
    }
    ...
    function Un(n) {
        var t = n.decimal
          ...
          , i = n.currency
          , u = r && e ? function(n, t) {
            for (var i = n.length, u = [], o = 0, a = r[0], c = 0; i > 0 && a > 0 && (c + a + 1 > t && (a = Math.max(1, t - c)),
    ...
    function Hn(n, t, e) {
        ...
        function i(e) {
            return t(e = n(new la(e - 1)), 1),
            e
        }
        function u(n, e) {
            return t(n = new la((+n)), e),
            n
        }
        function o(n, r, u) {
            var o = i(n)
    ...
    function In(n) {
        function t(n) {
            function t(t) {
                for (var e, i, u, o = [], a = -1, c = 0; ++a < r; )
                    37 === n.charCodeAt(a) && (o.push(n.slice(c, a)),
                    null != (i = sa[e = n.charAt(++a)]) && (e = n.charAt(++a)),
        ...
        var A = {
            ...
            j: function(n, t) {
                return Yn(1 + ca.dayOfYear(n), t, 3)
            },
            L: function(n, t) {
            ...
            U: function(n, t) {
                return Yn(ca.sundayOfYear(n), t, 2)
            },
            w: function(n) {
                return n.getDay()
            },
            W: function(n, t) {
                return Yn(ca.mondayOfYear(n), t, 2)
            },
            x: t(h),
            X: t(p),
            y: function(n, t) {
    ...
    function Xn(n, t, e) {
        ha.lastIndex = 0;
        var r = ha.exec(t.slice(e, e + 1));
        return r ? (n.w = +r[0],
        e + r[0].length) : -1
    }
    function $n(n, t, e) {
        ha.lastIndex = 0;
        var r = ha.exec(t.slice(e));
        return r ? (n.U = +r[0],
        e + r[0].length) : -1
    }
    function Bn(n, t, e) {
    ...
    function Wn(n, t, e) {
        ha.lastIndex = 0;
        var r = ha.exec(t.slice(e, e + 4));
        return r ? (n.y = +r[0],
        e + r[0].length) : -1
    }
    function Jn(n, t, e) {
        ha.lastIndex = 0;
        var r = ha.exec(t.slice(e, e + 2));
        return r ? (n.y = Kn(+r[0]),
        e + r[0].length) : -1
    }
    function Gn(n, t, e) {
    ...
    function _t(n, t) {
        return po(n[0] - t[0]) < zo && po(n[1] - t[1]) < zo
    }
    function wt(n, t) {
        n *= Po;
        var e = Math.cos(t *= Po);
        ...
        return function(i, u) {
            ...
            var p, g, v, d = t(u), y = i.invert(r[0], r[1]), m = {
                ...
                polygonEnd: function() {
                    ...
                    b = !0),
                    zt(p, Pt, n, e, u)) : n && (b || (u.polygonStart(),
                    b = !0),
                    u.lineStart(),
                    e(null, null, 1, u),
                    u.lineEnd()),
    ...
    function Pt(n, t) {
        return ((n = n.x)[0] < 0 ? n[1] - Do - zo : Do - n[1]) - ((t = t.x)[0] < 0 ? t[1] - Do - zo : Do - t[1])
    }
    function Ut(n) {
        ...
        return {
            ...
            point: function(u, o) {
                var a = u > 0 ? Lo : -Lo
                  , c = po(u - e);
                po(c - Lo) < zo ? (n.point(e, r = (r + o) / 2 > 0 ? Do : -Do),
                n.point(i, r),
                n.lineEnd(),
                n.lineStart(),
                n.point(a, r),
                n.point(u, r),
                t = 0) : i !== a && c >= Lo && (po(e - i) < zo && (e -= i * zo),
                po(u - a) < zo && (u -= a * zo),
                r = jt(e, r, u, o),
                n.point(i, r),
                n.lineEnd(),
    ...
    function jt(n, t, e, r) {
        ...
        return po(o) > zo ? Math.atan((Math.sin(t) * (u = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (i = Math.cos(t)) * Math.sin(n)) / (i * u * o)) : (t + r) / 2
    }
    function Ft(n, t, e, r) {
        var i;
        if (null == n)
    ...
    function Ht(n, t) {
        ...
        for (var a = 0, c = t.length; c > a; ++a) {
            var l = t[a]
              , f = l.length;
            if (f)
                for (var s = l[0], h = s[0], p = s[1] / 2 + Lo / 4, g = Math.sin(p), v = Math.cos(p), d = 1; ; ) {
                    d === f && (d = 0),
                    n = l[d];
                    var y = n[0]
                      , m = n[1] / 2 + Lo / 4
                      ...
                      , S = w > Lo
                      , k = g * M;
                    if (Ma.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))),
                    u += S ? b + _ * To : b,
                    S ^ h >= e ^ y >= e) {
                        var N = yt(vt(s), vt(n));
                        xt(N);
    ...
    function Ot(n) {
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(s, h) {
                    var p, g = [s, h], v = t(s, h), d = o ? v ? 0 : i(s, h) : v ? i(s + (0 > s ? Lo : -Lo), h) : 0;
                    if (!e && (l = c = v) && n.lineStart(),
                    v !== c && (p = r(e, g),
                    (_t(e, p) || _t(g, p)) && (g[0] += zo,
                    g[1] += zo,
                    v = t(g[0], g[1]))),
                    v !== c)
                        f = 0,
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                k = N,
                N = _),
                C ? A ? k + N > 0 ^ b[1] < (po(b[0] - w) < zo ? k : N) : k <= b[1] && b[1] <= N : E > Lo ^ (w <= b[0] && b[0] <= S)) {
                    var z = Mt(d, (-y + x) / m);
                    return mt(z, g),
                    [b, bt(z)]
                }
        ...
        var u = Math.cos(n)
          ...
          , a = po(u) > zo
          , c = ge(n, 6 * Po);
        return Tt(t, e, c, o ? [0, -n] : [-Lo, n - Lo])
    }
    function It(n, t, e, r) {
        return function(i) {
            var u, o = i.a, a = i.b, c = o.x, l = o.y, f = a.x, s = a.y, h = 0, p = 1, g = f - c, v = s - l;
            if (u = n - c,
            g || !(u > 0)) {
                if (u /= g,
                0 > g) {
    ...
    function Yt(n, t, e, r) {
        function i(r, i) {
            return po(r[0] - n) < zo ? i > 0 ? 0 : 3 : po(r[0] - e) < zo ? i > 0 ? 2 : 1 : po(r[1] - t) < zo ? i > 0 ? 1 : 0 : i > 0 ? 3 : 2
        }
        function u(n, t) {
            return o(n.x, t.x)
        }
        ...
        return function(a) {
            function c(n) {
                for (var t = 0, e = d.length, r = n[1], i = 0; e > i; ++i)
                    for (var u, o = 1, a = d[i], c = a.length, l = a[0]; c > o; ++o)
                        u = a[o],
                        l[1] <= r ? u[1] > r && Q(l, u, n) > 0 && ++t : u[1] <= r && Q(l, u, n) < 0 && --t,
                        l = u;
                return 0 !== t
            }
            function l(u, a, c, l) {
            ...
            function g(n, t) {
                n = Math.max(-Ra, Math.min(Ra, n)),
                t = Math.max(-Ra, Math.min(Ra, t));
                var e = f(n, t);
                if (d && y.push([n, t]),
                S)
                    m = n,
            ...
            var v, d, y, m, M, x, b, _, w, S, k, N = a, E = Dt(), A = It(n, t, e, r), C = {
                point: s,
                lineStart: h,
                lineEnd: p,
                polygonStart: function() {
    ...
    function Zt(n) {
        ...
        return i.parallels = function(n) {
            return arguments.length ? r(t = n[0] * Lo / 180, e = n[1] * Lo / 180) : [t / Lo * 180, e / Lo * 180]
        }
        ,
        i
    }
        ...
        function i(t, e, r, a, c, l, f, s, h, p, g, v, d, y) {
            ...
            if (x > 4 * u && d--) {
                var b = a + p
                  ...
                  , k = Math.asin(w /= S)
                  , N = po(po(w) - 1) < zo || po(r - h) < zo ? (r + h) / 2 : Math.atan2(_, b)
                  , E = n(N, k)
                  , A = E[0]
                  , C = E[1]
                  , z = A - t
                  , q = C - e
                  , L = M * z - m * q;
                (L * L / x > u || po((m * z + M * q) / x - .5) > .3 || o > a * p + c * g + l * v) && (i(t, e, r, a, c, l, A, C, N, b /= S, _ /= S, w, d, y),
                y.point(A, C),
    ...
    function oe(n) {
        ...
        var u, o, a, c, l, f, s = te(function(n, t) {
            return n = u(n, t),
            [n[0] * h + c, l - n[1] * h]
        }), h = 150, p = 480, g = 250, v = 0, d = 0, y = 0, M = 0, x = 0, b = Ta, _ = m, w = null, S = null;
        ...
        t.clipExtent = function(n) {
            ...
            _ = n ? Yt(n[0][0], n[0][1], n[1][0], n[1][1]) : m,
            i()) : S
        }
        ,
        t.scale = function(n) {
        ...
        ,
        t.center = function(n) {
            return arguments.length ? (v = n[0] % 360 * Po,
            d = n[1] % 360 * Po,
            r()) : [v * Uo, d * Uo]
        }
        ,
        t.rotate = function(n) {
            return arguments.length ? (y = n[0] % 360 * Po,
            M = n[1] % 360 * Po,
            x = n.length > 2 ? n[2] % 360 * Po : 0,
            r()) : [y * Uo, M * Uo, x * Uo]
        }
        ,
    ...
    function se(n) {
        return function(t, e) {
            return t += n,
            [t > Lo ? t - To : -Lo > t ? t + To : t, e]
        }
    }
    function he(n) {
        var t = se(n);
        return t.invert = se(-n),
        t
    }
    function pe(n, t) {
        function e(n, t) {
    ...
    function ge(n, t) {
        ...
        return function(i, u, o, a) {
            ...
            null != i ? (i = ve(e, i),
            u = ve(e, u),
            (o > 0 ? u > i : i > u) && (i += o * To)) : (i = n + o * To,
            u = n - .5 * c);
            for (var l, f = i; o > 0 ? f > u : u > f; f -= c)
                a.point((l = bt([e, -r * Math.cos(f), -r * Math.sin(f)]))[0], l[1])
        }
    }
    function ve(n, t) {
        var e = vt(t);
        ...
        xt(e);
        var r = nn(-e[1]);
        return ((-e[2] < 0 ? -r : r) + 2 * Math.PI - zo) % (2 * Math.PI)
    }
    function de(n, t, e) {
        var r = to.range(n, t - zo, e).concat(t);
        return function(n) {
        ...
        var i = Math.cos(t)
          ...
          , g = h ? function(n) {
            var t = Math.sin(n *= h) * p
              ...
              , i = e * l + t * s
              , o = e * u + t * a;
            return [Math.atan2(i, r) * Uo, Math.atan2(o, Math.sqrt(r * r + i * i)) * Uo]
        }
        : function() {
            return [n * Uo, t * Uo]
        }
    ...
    function be() {
        function n(n, i) {
            var u = Math.sin(i *= Po)
              ...
              , a = po((n *= Po) - t)
              , c = Math.cos(a);
            Za += Math.atan2(Math.sqrt((a = o * Math.sin(a)) * a + (a = r * u - e * o * c) * a), e * u + r * o * c),
            t = n,
            e = u,
            r = o
        }
        var t, e, r;
        Va.point = function(i, u) {
            t = i * Po,
            e = Math.sin(u *= Po),
            r = Math.cos(u),
            Va.point = n
    ...
    function we(n, t) {
        function e(n, t) {
            o > 0 ? -Do + zo > t && (t = -Do + zo) : t > Do - zo && (t = Do - zo);
        ...
        return u ? (e.invert = function(n, t) {
            ...
            return [Math.atan2(n, e) / u, 2 * Math.atan(Math.pow(o / r, 1 / u)) - Do]
        }
        ,
        e) : ke
    }
    function Se(n, t) {
        ...
        var r = Math.cos(n)
          ...
          , u = r / i + n;
        return po(i) < zo ? ce : (e.invert = function(n, t) {
            var e = u - t;
    ...
    function Ne(n) {
        var t, e = ue(n), r = e.scale, i = e.translate, u = e.clipExtent;
    ...
    function je(n) {
        var t = n.circle
          ...
          , a = [n];
        Ue(n);
        for (var c = u; c.circle && po(e - c.circle.x) < zo && po(r - c.circle.cy) < zo; )
            u = c.P,
            a.unshift(c),
            Ue(c),
            c = u;
        a.unshift(c),
        $e(c);
        for (var l = o; l.circle && po(e - l.circle.x) < zo && po(r - l.circle.cy) < zo; )
            o = l.N,
            a.push(l),
            Ue(l),
            l = o;
        ...
        for (f = 1; s > f; ++f)
            l = a[f],
            c = a[f - 1],
            Qe(l.edge, c.site, l.site, i);
        c = a[0],
        l = a[s - 1],
        l.edge = Ge(c.site, l.site, null, i),
        Xe(c),
        Xe(l)
    }
    function Fe(n) {
        for (var t, e, r, i, u = n.x, o = n.y, a = nc._; a; )
            if (r = He(a, o) - u,
            r > zo)
                a = a.L;
            else {
        ...
        t || e) {
            if (t === e)
                ...
                void Xe(e);
            if (!e)
                return void (c.edge = Ge(t.site, c.site));
            $e(t),
            $e(e);
            var l = t.site
              , f = l.x
    ...
    function Ye(n) {
        for (var t, e, r, i, u, o, a, c, l, f, s = n[0][0], h = n[1][0], p = n[0][1], g = n[1][1], v = Qa, d = v.length; d--; )
            if (u = v[d],
            u && u.prepare())
                for (a = u.edges,
                c = a.length,
                o = 0; c > o; )
                    ...
                    t = l.x,
                    e = l.y,
                    (po(r - t) > zo || po(i - e) > zo) && (a.splice(o, 0, new nr(Ke(u.site, f, po(r - s) < zo && g - i > zo ? {
                        x: s,
                        y: po(t - s) < zo ? e : g
                    } : po(i - g) < zo && h - r > zo ? {
                        x: po(e - g) < zo ? t : h,
    ...
    function Be(n) {
        for (var t, e = Ka, r = It(n[0][0], n[0][1], n[1][0], n[1][1]), i = e.length; i--; )
            t = e[i],
            (!We(t, n) || !r(t) || po(t.a.x - t.b.x) < zo && po(t.a.y - t.b.y) < zo) && (t.a = t.b = null,
            e.splice(i, 1))
    }
    function We(n, t) {
        var e = n.b;
        if (e)
            return !0;
        var r, i, u = n.a, o = t[0][0], a = t[1][0], c = t[0][1], l = t[1][1], f = n.l, s = n.r, h = f.x, p = f.y, g = s.x, v = s.y, d = (h + g) / 2, y = (p + v) / 2;
        if (v === p) {
            if (o > d || d >= a)
                return;
            if (h > g) {
    ...
    function Ge(n, t, e, r) {
        ...
        e && Qe(i, n, t, e),
        r && Qe(i, t, n, r),
        Qa[n.i].edges.push(new nr(i,n,t)),
        Qa[t.i].edges.push(new nr(i,t,n)),
        i
    }
    function Ke(n, t, e) {
        var r = new Je(n,null);
    ...
    function or(n, t) {
        ...
        for (Ka = [],
        Qa = new Array(n.length),
        nc = new tr,
        ec = new tr; ; )
            if (i = tc,
            u && (!i || u.y < i.y || u.y === i.y && u.x < i.x))
                (u.x !== e || u.y !== r) && (Qa[u.i] = new Ie(u),
                Fe(u),
                e = u.x,
                r = u.y),
                u = n.pop();
    ...
    function hr(n, t, e, r, i, u) {
        if (!n(t, e, r, i, u)) {
            var o = .5 * (e + i)
              , a = .5 * (r + u)
              , c = t.nodes;
            c[0] && hr(n, c[0], e, r, o, a),
            c[1] && hr(n, c[1], o, r, i, a),
            c[2] && hr(n, c[2], e, a, o, u),
            c[3] && hr(n, c[3], o, a, i, u)
        }
    }
    function pr(n, t, e, r, i, u, o) {
        var a, c = 1 / 0;
        return function l(n, f, s, h, p) {
            if (!(f > u || s > o || r > h || i > p)) {
                if (g = n.point) {
    ...
    function yr(n, t) {
        var e, r, i, u = oc.lastIndex = ac.lastIndex = 0, o = -1, a = [], c = [];
        for (n += "",
        t += ""; (e = oc.exec(n)) && (r = ac.exec(t)); )
    ...
    function zr(n, t) {
        ...
        arguments.length ? e = t / To * Math.asin(1 / n) : (n = 1,
        e = t / 4),
        function(r) {
            return 1 + n * Math.pow(2, -10 * r) * Math.sin((r - e) * To / t)
        }
    }
    function qr(n) {
        return n || (n = 1.70158),
    ...
    function Ur(n) {
        ...
        r *= -1,
        i *= -1),
        this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Uo,
        this.translate = [n.e, n.f],
        this.scale = [r, u],
        this.skew = u ? Math.atan2(i, u) * Uo : 0
    }
    function jr(n, t) {
        return n[0] * t[0] + n[1] * t[1]
    }
    ...
    function Or(n, t) {
        var e, r = [], i = [], u = to.transform(n), o = to.transform(t), a = u.translate, c = o.translate, l = u.rotate, f = o.rotate, s = u.skew, h = o.skew, p = u.scale, g = o.scale;
        ...
        p[0] != g[0] || p[1] != g[1] ? (e = r.push(r.pop() + "scale(", null, ",", null, ")"),
        i.push({
            i: e - 4,
            x: dr(p[0], g[0])
        }, {
    ...
    function Xr(n, t) {
        if (n === t)
            return n;
        for (var e = Vr(n), r = Vr(t), i = e.pop(), u = r.pop(), o = null; i === u; )
            o = i,
            i = e.pop(),
            u = r.pop();
        return o
    ...
    function Gr(n, t, e) {
        ...
        if (n.charge = 0,
        !n.leaf)
            for (var u, o = n.nodes, a = o.length, c = -1; ++c < a; )
                u = o[c],
                null != u && (Gr(u, t, e),
                n.charge += u.charge,
                r += u.charge * u.cx,
    ...
    function Kr(n, t) {
        return to.rebind(n, t, "sort", "children", "value"),
        n.nodes = n,
        n.links = ii,
        n
    }
    ...
    function xi(n) {
        ...
        if ((e = n.children) && (l = e.length)) {
            var e, r, i, u, o, a, c, l, f = 1 / 0, s = -1 / 0, h = 1 / 0, p = -1 / 0;
            if (e.forEach(bi),
            r = e[0],
            r.x = -r.r,
            r.y = 0,
            ...
            l > 2))
                ...
                o = 3; l > o; o++) {
                    ...
                    if (1 == g)
                        for (c = r._pack_prev; c !== a._pack_prev && !Mi(c, u); c = c._pack_prev,
                        d++)
                            ;
                    g ? (d > v || v == d && i.r < r.r ? mi(r, i = a) : mi(r = c, i),
                    o--) : (yi(r, u),
                    i = u,
                    t(u))
                }
    ...
    function Bi(n, t, e) {
        ...
        if (e) {
            ...
            if (i.shift(),
            "s" === i[8]) {
                var u = to.formatPrefix(Math.max(po(r[0]), po(r[1])));
                return i[7] || (i[7] = "." + Wi(u.scale(r[2]))),
                i[8] = "f",
                e = to.format(i.join("")),
                function(n) {
    ...
    function Ji(n, t) {
        var e = Wi(t[2]);
        return n in Mc ? Math.abs(e - Wi(Math.max(po(t[0]), po(t[1])))) + +("e" !== n) : e - 2 * ("%" === n)
    }
    function Gi(n, t, e, r) {
        function i(n) {
        ...
        o.tickFormat = function(n, t) {
            if (!arguments.length)
                return xc;
            arguments.length < 2 ? t = xc : "function" != typeof t && (t = to.format(t));
    ...
    function Ki(n, t, e) {
        ...
        r.exponent = function(o) {
            return arguments.length ? (i = Qi(t = o),
            u = Qi(1 / t),
            n.domain(e.map(i)),
            r) : t
        }
    ...
    function nu(n, t) {
        ...
        e.rangePoints = function(i, a) {
            ...
            var c = i[0]
              , l = i[1]
              , f = n.length < 2 ? (c = (c + l) / 2,
            0) : (l - c) / (n.length - 1 + a);
            return u = r(c + f * a / 2, f),
            o = 0,
            t = {
                t: "rangePoints",
                a: arguments
        ...
        e.rangeRoundPoints = function(i, a) {
            ...
            var c = i[0]
              , l = i[1]
              , f = n.length < 2 ? (c = l = Math.round((c + l) / 2),
            0) : (l - c) / (n.length - 1 + a) | 0;
            return u = r(c + Math.round(f * a / 2 + (l - c - (n.length - 1 + a) * f) / 2), f),
            o = 0,
            t = {
                t: "rangeRoundPoints",
                a: arguments
    ...
    function pu(n) {
        function t(t) {
            ...
            for (var c, l = [], f = [], s = -1, h = t.length, p = En(e), g = En(r); ++s < h; )
                i.call(this, c = t[s], s) ? f.push([+p.call(this, c, s), +g.call(this, c, s)]) : f.length && (o(),
                f = []);
            return f.length && o(),
        ...
        t.interpolate = function(n) {
            return arguments.length ? (o = "function" == typeof n ? u = n : (u = Ec.get(n) || gu).key,
            t) : o
        }
        ,
    ...
    function xu(n, t) {
        return n.length < 3 ? gu(n) : n[0] + _u((n.push(n[0]),
        n), wu([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    function bu(n, t) {
    ...
    function wu(n, t) {
        for (var e, r = [], i = (1 - t) / 2, u = n[0], o = n[1], a = 1, c = n.length; ++a < c; )
            e = u,
            u = o,
            o = n[a],
    ...
    function Eu(n, t) {
        var e = n.length - 1;
        if (e)
            for (var r, i, u = n[0][0], o = n[0][1], a = n[e][0] - u, c = n[e][1] - o, l = -1; ++l <= e; )
                r = n[l],
                i = l / e,
                r[0] = t * r[0] + (1 - t) * (u + i * a),
                r[1] = t * r[1] + (1 - t) * (o + i * c);
    ...
    function Cu(n, t, e) {
        n.push("C", Au(Ac, t), ",", Au(Ac, e), ",", Au(Cc, t), ",", Au(Cc, e), ",", Au(zc, t), ",", Au(zc, e))
    }
    function zu(n, t) {
    ...
    function Lu(n) {
        for (var t, e, r, i, u = [], o = qu(n), a = -1, c = n.length - 1; ++a < c; )
            t = zu(n[a], n[a + 1]),
            po(t) < zo ? o[a] = o[a + 1] = 0 : (e = o[a] / t,
            r = o[a + 1] / t,
            i = e * e + r * r,
            ...
            o[a + 1] = i * r));
        for (a = -1; ++a <= c; )
            i = (n[Math.min(c, a + 1)][0] - n[Math.max(0, a - 1)][0]) / (6 * (1 + o[a] * o[a])),
            u.push([i || 0, o[a] * i || 0]);
        return u
    }
    function Tu(n) {
    ...
    function Du(n) {
        function t(t) {
            ...
            : En(u); ++m < M; )
                ...
                y.push([+_.call(this, h, m), +w.call(this, h, m)])) : d.length && (c(),
                d = [],
                y = []);
            return d.length && c(),
        ...
        ,
        t.interpolate = function(n) {
            return arguments.length ? (c = "function" == typeof n ? a = n : (a = Ec.get(n) || gu).key,
            l = a.reverse || a,
            f = a.closed ? "M" : "L",
            t) : c
        }
        ...
        if (!o) {
            ...
            to.timer(function(i) {
                ...
                function l(e) {
                    if (u.active !== r)
                        return 1;
                    for (var i = e / s, a = h(i), c = v.length; c > 0; )
                        v[--c].call(n, a);
                    return i >= 1 ? (o.event && o.event.end.call(n, n.__data__, t),
                    f()) : void 0
                }
                function f() {
                    return --u.count ? delete u[r] : delete n[e],
                    1
                }
                var s, h, p = o.delay, g = ra, v = [];
                return g.t = p + a,
                i >= p ? c(i - p) : void (g.c = c)
            }, 0, a)
        }
    }
    function Bu(n, t, e) {
    ...
    function Gu(n, t, e) {
        ...
        function i(n, e) {
            var r = n[1] - n[0]
              , i = r / e
              , u = to.bisect(Xc, i);
            return u == Xc.length ? [t.year, Xi(n.map(function(n) {
                return n / 31536e6
            }), e)[2]] : u ? t[i / Xc[u - 1] < Xc[u] / i ? u - 1 : u] : [Wc, Xi(n, e)[2]]
        }
        return r.invert = function(t) {
    ...
    io)
        try {
            ...
            var ao = this.Element.prototype
              , co = ao.setAttribute
              , lo = ao.setAttributeNS
              , fo = this.CSSStyleDeclaration.prototype
              , so = fo.setProperty;
            ao.setAttribute = function(n, t) {
                co.call(this, n, t + "")
            }
            ,
            ao.setAttributeNS = function(n, t, e) {
                lo.call(this, n, t, e + "")
            }
            ,
            fo.setProperty = function(n, t, e) {
                so.call(this, n, t + "", e)
            }
        }
    to.ascending = e,
    ...
    to.mean = function(n, t) {
        var e, u = 0, o = n.length, a = -1, c = o;
        if (1 === arguments.length)
            for (; ++a < o; )
                i(e = r(n[a])) ? u += e : --c;
        else
            for (; ++a < o; )
                i(e = r(t.call(n, n[a], a))) ? u += e : --c;
        return c ? u / c : void 0
    }
    ,
    ...
    to.median = function(n, t) {
        var u, o = [], a = n.length, c = -1;
        if (1 === arguments.length)
            for (; ++c < a; )
                i(u = r(n[c])) && o.push(u);
        else
            for (; ++c < a; )
                i(u = r(t.call(n, n[c], c))) && o.push(u);
        return o.length ? to.quantile(o.sort(e), .5) : void 0
    }
    ,
    to.variance = function(n, t) {
        var e, u, o = n.length, a = 0, c = 0, l = -1, f = 0;
        if (1 === arguments.length)
            for (; ++l < o; )
                i(e = r(n[l])) && (u = e - a,
                a += u / ++f,
    ...
    ;
    var ho = u(e);
    to.bisectLeft = ho.left,
    to.bisect = to.bisectRight = ho.right,
    ...
    to.nest = function() {
        function n(t, o, a) {
            ...
            for (var c, f, s, h, p = -1, g = o.length, v = u[a++], d = new l; ++p < g; )
                (h = d.get(c = v(f = o[p]))) ? h.push(f) : d.set(c, [f]);
            return t ? (f = t(),
            s = function(e, r) {
                f.set(e, n(t, r, a))
            }
    ...
    wo.select = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a; ) {
            ...
            for (var c = -1, l = r.length; ++c < l; )
                (i = r[c]) ? (t.push(e = n.call(i, i.__data__, c, o)),
    ...
    wo.selectAll = function(n) {
        ...
        for (var i = -1, u = this.length; ++i < u; )
            for (var o = this[i], a = -1, c = o.length; ++a < c; )
                (e = o[a]) && (r.push(t = ro(n.call(e, e.__data__, a, i))),
                t.parentNode = e);
        return E(r)
    }
    ;
    ...
    ,
    wo.data = function(n, t) {
        function e(n, e) {
            var r, i, u, o = n.length, s = e.length, h = Math.min(o, s), p = new Array(s), g = new Array(s), v = new Array(o);
            if (t) {
                var d, y = new l, m = new Array(o);
                for (r = -1; ++r < o; )
                    y.has(d = t.call(i = n[r], i.__data__, r)) ? v[r] = i : y.set(d, i),
                    m[r] = d;
                for (r = -1; ++r < s; )
    ...
    to.selection.enter.prototype = ko,
    ko.append = wo.append,
    ko.empty = wo.empty,
    ko.node = wo.node,
    ko.call = wo.call,
    ko.size = wo.size,
    ko.select = function(n) {
        for (var t, e, r, i, u, o = [], a = -1, c = this.length; ++a < c; ) {
            r = (i = this[a]).update,
            o.push(t = []),
            t.parentNode = i.parentNode;
            for (var l = -1, f = i.length; ++l < f; )
                (u = i[l]) ? (t.push(r[l] = e = n.call(i.parentNode, u.__data__, l, a)),
                e.__data__ = u.__data__) : t.push(null)
        }
        return E(o)
    }
    ,
    ko.insert = function(n, t) {
        return arguments.length < 2 && (t = V(this)),
        wo.insert.call(this, n, t)
    }
    ,
    to.select = function(t) {
        var e;
        return "string" == typeof t ? (e = [xo(t, io)],
        e.parentNode = io.documentElement) : (e = [t],
        e.parentNode = n(t)),
        E([e])
    }
    ,
    to.selectAll = function(n) {
        var t;
        return "string" == typeof n ? (t = ro(bo(n, io)),
        t.parentNode = io.documentElement) : (t = n,
        t.parentNode = null),
        E([t])
    }
    ,
    wo.on = function(n, t, e) {
    ...
    io && No.forEach(function(n) {
        "on" + n in io && No.remove(n)
    });
    var Eo, Ao = 0;
    to.mouse = function(n) {
        return J(n, k())
        ...
        function e(n, t, e, u, o) {
            return function() {
                ...
                function c() {
                    ...
                    m(g && to.event.target === s),
                    p({
                        type: "dragend"
                    }))
                }
                var l, f = this, s = to.event.target, h = f.parentNode, p = r.of(f, arguments), g = 0, v = n(), d = ".drag" + (null == v ? "" : "-" + v), y = to.select(e(s)).on(u + d, a).on(o + d, c), m = W(s), M = t(h, v);
                i ? (l = i.apply(f, arguments),
    ...
    to.interpolateZoom = function(n, t) {
        function e(n) {
            ...
            if (y) {
                var e = rn(v)
                  , o = u / (Fo * h) * (e * un(jo * t + v) - en(v));
                return [r + o * l, i + o * f, u * e / rn(jo * t + v)]
            }
            return [r + n * l, i + n * f, u * Math.exp(jo * t)]
        }
        var r = n[0]
          , i = n[1]
          , u = n[2]
          ...
          , s = l * l + f * f
          , h = Math.sqrt(s)
          , p = (c * c - u * u + Ho * s) / (2 * u * Fo * h)
          , g = (c * c - u * u - Ho * s) / (2 * c * Fo * h)
          , v = Math.log(Math.sqrt(p * p + 1) - p)
          , d = Math.log(Math.sqrt(g * g + 1) - g)
          , y = d - v
          , m = (y || Math.log(c / u)) / jo;
        return e.duration = 1e3 * m,
        e
    }
    ,
    to.behavior.zoom = function() {
        function n(n) {
            n.on(q, s).on(Io + ".zoom", p).on("dblclick.zoom", g).on(R, h)
        }
        function e(n) {
        ...
        function h() {
            ...
            function t() {
                ...
                to.select(t).on(x, r).on(b, a),
                _.push(t);
                for (var e = to.event.changedTouches, i = 0, u = e.length; u > i; ++i)
            ...
            function a() {
                if (to.event.touches.length) {
                    for (var t = to.event.changedTouches, e = 0, r = t.length; r > e; ++e)
                        delete d[t[e].identifier];
                    for (var i in d)
                        return void n()
                }
                to.selectAll(_).on(m, null),
                w.on(q, s).on(R, h),
                N(),
                f(v)
            }
            var p, g = this, v = D.of(g, arguments), d = {}, y = 0, m = ".zoom-" + to.event.changedTouches[0].identifier, x = "touchmove" + m, b = "touchend" + m, _ = [], w = to.select(g), N = W(g);
            t(),
            c(v),
            w.on(q, null).on(R, t)
        }
        function p() {
            ...
            m ? clearTimeout(m) : (v = e(d = y || to.mouse(this)),
            Pc.call(this),
            c(n)),
        ...
        var v, d, y, m, M, x, b, _, w, k = {
            ...
            y: 0,
            k: 1
        }, E = [960, 500], A = Yo, C = 250, z = 0, q = "mousedown.zoom", L = "mousemove.zoom", T = "mouseup.zoom", R = "touchstart.zoom", D = N(n, "zoomstart", "zoom", "zoomend");
        return Io || (Io = "onwheel"in io ? (Oo = function() {
            return -to.event.deltaY * (to.event.deltaMode ? 120 : 1)
        }
        ,
        "wheel") : "onmousewheel"in io ? (Oo = function() {
        ...
        n.event = function(n) {
            n.each(function() {
                var n = D.of(this, arguments)
                  , t = k;
                Rc ? to.select(this).transition().each("start.zoom", function() {
                    k = this.__chart__ || {
                        x: 0,
                        y: 0,
                        k: 1
        ...
        n.scaleExtent = function(t) {
            return arguments.length ? (A = null == t ? Yo : [+t[0], +t[1]],
            n) : A
        }
        ,
        n.center = function(t) {
    ...
    ,
    to.hsl = cn;
    var Zo = cn.prototype = new an;
    Zo.brighter = function(n) {
        return n = Math.pow(.7, arguments.length ? n : 1),
        new cn(this.h,this.s,this.l / n)
    }
    ,
    Zo.darker = function(n) {
        return n = Math.pow(.7, arguments.length ? n : 1),
        new cn(this.h,this.s,n * this.l)
    }
    ,
    Zo.rgb = function() {
    ...
    ,
    to.hcl = fn;
    var Vo = fn.prototype = new an;
    Vo.brighter = function(n) {
        return new fn(this.h,this.c,Math.min(100, this.l + Xo * (arguments.length ? n : 1)))
    }
    ,
    Vo.darker = function(n) {
        return new fn(this.h,this.c,Math.max(0, this.l - Xo * (arguments.length ? n : 1)))
    }
    ,
    Vo.rgb = function() {
    ...
    var Xo = 18
      ...
      , Bo = 1
      , Wo = 1.08883
      , Jo = hn.prototype = new an;
    Jo.brighter = function(n) {
        return new hn(Math.min(100, this.l + Xo * (arguments.length ? n : 1)),this.a,this.b)
    }
    ,
    Jo.darker = function(n) {
        return new hn(Math.max(0, this.l - Xo * (arguments.length ? n : 1)),this.a,this.b)
    }
    ,
    Jo.rgb = function() {
    ...
    to.dsv = function(n, t) {
        ...
        e.parseRows = function(n, t) {
            ...
            for (var r, i, u = {}, o = {}, a = [], l = n.length, f = 0, s = 0; (r = e()) !== o; ) {
                for (var h = []; r !== u && r !== o; )
                    h.push(r),
                    r = e();
    ...
    var Qo, na, ta, ea, ra, ia = this[x(this, "requestAnimationFrame")] || function(n) {
        setTimeout(n, 17)
    }
    ;
    ...
    ;
    var ua = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(Pn);
    to.formatPrefix = function(n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1),
        t && (n = to.round(n, Dn(n, t))),
    ...
    Fn.prototype = {
        ...
        setDate: function() {
            fa.setUTCDate.apply(this._, arguments)
        },
        setDay: function() {
            fa.setUTCDay.apply(this._, arguments)
        },
        setFullYear: function() {
            fa.setUTCFullYear.apply(this._, arguments)
        },
        setHours: function() {
            fa.setUTCHours.apply(this._, arguments)
        },
        setMilliseconds: function() {
            fa.setUTCMilliseconds.apply(this._, arguments)
        },
        setMinutes: function() {
            fa.setUTCMinutes.apply(this._, arguments)
        },
        setMonth: function() {
            fa.setUTCMonth.apply(this._, arguments)
        },
        setSeconds: function() {
            fa.setUTCSeconds.apply(this._, arguments)
        },
        setTime: function() {
            fa.setTime.apply(this._, arguments)
        }
    };
    var fa = Date.prototype;
    ca.year = Hn(function(n) {
        return n = ca.day(n),
        n.setMonth(0, 1),
        n
    }, function(n, t) {
    ...
    ca.years = ca.year.range,
    ca.years.utc = ca.year.utc.range,
    ca.day = Hn(function(n) {
        var t = new la(2e3,0);
    ...
    ca.days = ca.day.range,
    ca.days.utc = ca.day.utc.range,
    ca.dayOfYear = function(n) {
        var t = ca.year(n);
    ...
    ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"].forEach(function(n, t) {
        t = 7 - t;
        var e = ca[n] = Hn(function(n) {
            return (n = ca.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7),
            n
        }, function(n, t) {
            n.setDate(n.getDate() + 7 * Math.floor(t))
        }, function(n) {
            var e = ca.year(n).getDay();
            return Math.floor((ca.dayOfYear(n) + (e + t) % 7) / 7) - (e !== t)
        });
        ca[n + "s"] = e.range,
        ca[n + "s"].utc = e.utc.range,
        ca[n + "OfYear"] = function(n) {
            var e = ca.year(n).getDay();
            return Math.floor((ca.dayOfYear(n) + (e + t) % 7) / 7)
        }
    }),
    ca.week = ca.sunday,
    ca.weeks = ca.sunday.range,
    ca.weeks.utc = ca.sunday.utc.range,
    ca.weekOfYear = ca.sundayOfYear;
    var sa = {
        "-": "",
        _: " ",
        0: "0"
    ...
    to.geo.stream = function(n, t) {
        n && da.hasOwnProperty(n.type) ? da[n.type](n, t) : st(n, t)
    }
    ;
    var da = {
    ...
    var ma, Ma = new lt, xa = {
        ...
        polygonEnd: function() {
            var n = 2 * Ma;
            ma += 0 > n ? 4 * Lo + n : n,
            xa.lineStart = xa.lineEnd = xa.point = b
        }
    };
        ...
        return function(n) {
            ...
            if (t) {
                ...
                for (var e, r = 1, i = M[0], u = [i]; t > r; ++r)
                    e = M[r],
                    l(e[0], i) || l(e[1], i) ? (a(i[0], e[1]) > a(i[0], i[1]) && (i[1] = e[1]),
            ...
            return M = x = null,
            1 / 0 === f || 1 / 0 === s ? [[NaN, NaN], [NaN, NaN]] : [[f, s], [h, p]]
        }
    }(),
    to.geo.centroid = function(n) {
        ba = _a = wa = Sa = ka = Na = Ea = Aa = Ca = za = qa = 0,
        to.geo.stream(n, La);
        var t = Ca
          , e = za
          , r = qa
        ...
        r = ka),
        i = t * t + e * e + r * r,
        qo > i) ? [NaN, NaN] : [Math.atan2(e, t) * Uo, tn(r / Math.sqrt(i)) * Uo]
    }
    ;
    var ba, _a, wa, Sa, ka, Na, Ea, Aa, Ca, za, qa, La = {
        sphere: b,
        point: wt,
        lineStart: kt,
        lineEnd: Nt,
    ...
    to.geo.clipExtent = function() {
        var n, t, e, r, i, u, o = {
            ...
            extent: function(a) {
                return arguments.length ? (u = Yt(n = +a[0][0], t = +a[0][1], e = +a[1][0], r = +a[1][1]),
                i && (i.valid = !1,
                i = null),
                o) : [[n, t], [e, r]]
            }
    ...
    to.geo.albersUsa = function() {
        ...
        var t, e, r, i, u = to.geo.albers(), o = to.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), a = to.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
            point: function(n, e) {
                t = [n, e]
            }
        };
        ...
        n.translate = function(t) {
            ...
            var l = u.scale()
              , f = +t[0]
              , s = +t[1];
            return e = u.translate(t).clipExtent([[f - .455 * l, s - .238 * l], [f + .455 * l, s + .238 * l]]).stream(c).point,
            r = o.translate([f - .307 * l, s + .201 * l]).clipExtent([[f - .425 * l + zo, s + .12 * l + zo], [f - .214 * l - zo, s + .234 * l - zo]]).stream(c).point,
            i = a.translate([f - .205 * l, s + .212 * l]).clipExtent([[f - .214 * l + zo, s + .166 * l + zo], [f - .115 * l - zo, s + .234 * l - zo]]).stream(c).point,
            n
        }
        ,
        n.scale(1070)
    ...
    var Da, Pa, Ua, ja, Fa, Ha, Oa = {
        ...
        polygonEnd: function() {
            Oa.lineStart = Oa.lineEnd = Oa.point = b,
            Da += po(Pa / 2)
        }
    }, Ia = {
        point: $t,
    ...
    to.geo.path = function() {
        ...
        return n.area = function(n) {
            return Da = 0,
            to.geo.stream(n, i(Oa)),
            Da
        }
        ,
        n.centroid = function(n) {
            return wa = Sa = ka = Na = Ea = Aa = Ca = za = qa = 0,
            to.geo.stream(n, i(Ya)),
            qa ? [Ca / qa, za / qa] : Aa ? [Na / Aa, Ea / Aa] : ka ? [wa / ka, Sa / ka] : [NaN, NaN]
        }
        ,
        n.bounds = function(n) {
            return Fa = Ha = -(Ua = ja = 1 / 0),
            to.geo.stream(n, i(Ia)),
            [[Ua, ja], [Fa, Ha]]
        }
        ,
        n.projection = function(n) {
            return arguments.length ? (i = (e = n) ? n.stream || ee(n) : m,
            t()) : e
        }
        ,
        n.context = function(n) {
            return arguments.length ? (u = null == (r = n) ? new Bt : new ne(n),
    ...
    to.geo.projection = ue,
    to.geo.projectionMutator = oe,
    ...
    to.geo.rotation = function(n) {
        function t(t) {
            return t = n(t[0] * Po, t[1] * Po),
            t[0] *= Uo,
            t[1] *= Uo,
            t
        }
        return n = fe(n[0] % 360 * Po, n[1] * Po, n.length > 2 ? n[2] * Po : 0),
        t.invert = function(t) {
            return t = n.invert(t[0] * Po, t[1] * Po),
            t[0] *= Uo,
            t[1] *= Uo,
            t
        }
    ...
    to.geo.circle = function() {
        ...
        ,
        n.angle = function(r) {
            return arguments.length ? (e = ge((t = +r) * Po, i * Po),
            n) : t
        }
        ,
        n.precision = function(r) {
            return arguments.length ? (e = ge(t * Po, (i = +r) * Po),
            n) : i
        }
        ,
        n.angle(90)
    ...
    to.geo.distance = function(n, t) {
        var e, r = (t[0] - n[0]) * Po, i = n[1] * Po, u = t[1] * Po, o = Math.sin(r), a = Math.cos(r), c = Math.sin(i), l = Math.cos(i), f = Math.sin(u), s = Math.cos(u);
    ...
    to.geo.graticule = function() {
        ...
        var e, r, i, u, o, a, c, l, f, s, h, p, g = 10, v = g, d = 90, y = 360, m = 2.5;
        ...
        ,
        n.majorExtent([[-180, -90 + zo], [180, 90 - zo]]).minorExtent([[-180, -80 - zo], [180, 80 + zo]])
    }
    ,
    ...
    to.geo.interpolate = function(n, t) {
        return xe(n[0] * Po, n[1] * Po, t[0] * Po, t[1] * Po)
    }
    ,
    ...
    ke.invert = function(n, t) {
        return [n, 2 * Math.atan(Math.exp(t)) - Do]
    }
    ,
    ...
    Ee.invert = function(n, t) {
        return [-t, 2 * Math.atan(Math.exp(n)) - Do]
    }
    ,
    ...
    to.geom.hull = function(n) {
        function t(n) {
            if (n.length < 3)
                return [];
            var t, i = En(e), u = En(r), o = n.length, a = [], c = [];
            for (t = 0; o > t; t++)
    ...
    ;
    var Ga = to.geom.polygon.prototype = [];
    Ga.area = function() {
    ...
    Ga.clip = function(n) {
        for (var t, e, r, i, u, o, a = Re(n), c = -1, l = this.length - Re(this), f = this[l - 1]; ++c < l; ) {
            ...
            e = -1; ++e < r; )
                o = t[e],
                Le(o, f, i) ? (Le(u, f, i) || n.push(Te(u, o, f, i)),
                n.push(o)) : Le(u, f, i) && n.push(Te(u, o, f, i)),
                u = o;
            a && n.push(n[0]),
            f = i
        }
    ...
    to.geom.voronoi = function(n) {
            ...
            return or(e(n), a).cells.forEach(function(e, a) {
                var c = e.edges
                  ...
                  , f = t[a] = c.length ? c.map(function(n) {
                    var t = n.start();
                    return [t.x, t.y]
                }) : l.x >= r && l.x <= u && l.y >= i && l.y <= o ? [[r, o], [u, o], [u, i], [r, i]] : [];
                f.point = n[a]
            }),
            t
        }
        function e(n) {
            return n.map(function(n, t) {
                return {
                    x: Math.round(u(n, t) / zo) * zo,
                    y: Math.round(o(n, t) / zo) * zo,
                    i: t
                }
            })
        }
        ...
        t.triangles = function(n) {
            ...
            return or(e(n)).cells.forEach(function(e, r) {
                for (var i, u, o = e.site, a = e.edges.sort(Ze), c = -1, l = a.length, f = a[l - 1].edge, s = f.l === o ? f.r : f.l; ++c < l; )
                    i = f,
                    u = s,
                    f = a[c].edge,
                    s = f.l === o ? f.r : f.l,
        ...
        ,
        t.clipExtent = function(n) {
            return arguments.length ? (a = null == n ? uc : n,
            t) : a === uc ? null : a
        }
        ,
        t.size = function(n) {
            return arguments.length ? t.clipExtent(n && [[0, 0], n]) : a === uc ? null : a && a[1]
        }
        ,
        t)
    }
    ;
    var uc = [[-1e6, -1e6], [1e6, 1e6]];
    ...
    to.geom.quadtree = function(n, t, e, r, i) {
        function u(n) {
            ...
            var f, s, h, p, g, v, d, y, m, M = En(a), x = En(c);
            if (null != t)
                v = t,
                d = e,
                y = r,
        ...
        var o, a = Ae, c = Ce;
        return (o = arguments.length) ? (a = lr,
        c = fr,
        3 === o && (i = e,
        r = t,
        e = t = 0),
    ...
    to.interpolateObject = vr,
    to.interpolateNumber = dr,
    to.interpolateString = yr;
    var oc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g
      , ac = new RegExp(oc.source,"g");
    to.interpolate = mr,
    to.interpolators = [function(n, t) {
        var e = typeof t;
        return ("string" === e ? Ko.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? gr : yr : t instanceof an ? gr : Array.isArray(t) ? Mr : "object" === e && isNaN(t) ? vr : dr)(n, t)
    }
    ],
    ...
    to.ease = function(n) {
        ...
        return e = lc.get(e) || cc,
        r = fc.get(r) || m,
        xr(r(e.apply(null, eo.call(arguments, 1))))
    }
    ,
    ...
    to.layout.chord = function() {
        function n() {
            var n, l, s, h, p, g = {}, v = [], d = to.range(u), y = [];
            for (e = [],
            r = [],
            n = 0,
            h = -1; ++h < u; ) {
    ...
    to.layout.force = function() {
        ...
        var e, r, i, u, o, a = {}, c = to.dispatch("start", "tick", "end"), l = [1, 1], f = .9, s = hc, h = pc, p = -30, g = gc, v = .1, d = .64, y = [], M = [];
        return a.tick = function() {
            if ((r *= .99) < .005)
                ...
                !0;
            var t, e, a, s, h, g, d, m, x, b = y.length, _ = M.length;
            for (e = 0; _ > e; ++e)
                a = M[e],
                s = a.source,
                h = a.target,
                m = h.x - s.x,
                x = h.y - s.y,
                (g = m * m + x * x) && (g = r * u[e] * ((g = Math.sqrt(g)) - i[e]) / g,
                m *= g,
                x *= g,
                h.x -= m * (d = s.weight / (h.weight + s.weight)),
                h.y -= x * d,
                s.x += m * (d = 1 - d),
                s.y += x * d);
            if ((d = r * v) && (m = l[0] / 2,
            ...
            d))
                for (; ++e < b; )
                    ...
                    a.y += (x - a.y) * d;
            if (p)
                for (Gr(t = to.geom.quadtree(y), r, o),
                e = -1; ++e < b; )
                    (a = y[e]).fixed || t.visit(n(a));
            for (e = -1; ++e < b; )
                a = y[e],
                a.fixed ? (a.x = a.px,
                a.y = a.py) : (a.x -= (a.px - (a.px = a.x)) * f,
                a.y -= (a.py - (a.py = a.y)) * f);
            c.tick({
                type: "tick",
                alpha: r
        ...
        a.start = function() {
            ...
            var t, e, r, c = y.length, f = M.length, g = l[0], v = l[1];
            for (t = 0; c > t; ++t)
                (r = y[t]).index = t,
                r.weight = 0;
            for (t = 0; f > t; ++t)
        ...
        ,
        a.drag = function() {
            return e || (e = to.behavior.drag().origin(m).on("dragstart.force", $r).on("drag.force", t).on("dragend.force", Br)),
            arguments.length ? void this.on("mouseover.force", Wr).on("mouseout.force", Jr).call(e) : e
        }
        ,
        to.rebind(a, c, "on")
    }
    ...
    to.layout.hierarchy = function() {
        function n(i) {
            ...
            for (i.depth = 0; null != (u = o.pop()); )
                if (a.push(u),
                (l = e.call(n, u, u.depth)) && (c = l.length)) {
                    for (var c, l, f; --c >= 0; )
                        o.push(f = l[c]),
                        f.parent = u,
                        f.depth = u.depth + 1;
    ...
    to.layout.pie = function() {
        function n(o) {
            var a, c = o.length, l = o.map(function(e, r) {
                return +t.call(n, e, r)
            }), f = +("function" == typeof r ? r.apply(this, arguments) : r), s = ("function" == typeof i ? i.apply(this, arguments) : i) - f, h = Math.min(Math.abs(s) / c, +("function" == typeof u ? u.apply(this, arguments) : u)), p = h * (0 > s ? -1 : 1), g = (s - c * p) / to.sum(l), v = to.range(c), d = [];
    ...
    to.layout.stack = function() {
        function n(a, c) {
            ...
            l = to.permute(l, s),
            f = to.permute(f, s);
            var h, p, g, v, d = r.call(n, f, c), y = l[0].length;
            for (g = 0; y > g; ++g)
                for (i.call(n, l[0][g], v = d[g], f[0][g][1]),
                p = 1; h > p; ++p)
                    i.call(n, l[p][g], v += f[p - 1][g][1], f[p][g][1]);
            return a
        }
        var t = m
          , e = ci
        ...
        ,
        n.order = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : dc.get(t) || ci,
            n) : e
        }
        ,
        n.offset = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : yc.get(t) || li,
            n) : r
        }
        ,
        n.x = function(t) {
    ...
    var dc = to.map({
        "inside-out": function(n) {
            var t, e, r = n.length, i = n.map(fi), u = n.map(si), o = to.range(r).sort(function(n, t) {
                return i[n] - i[t]
            }), a = 0, c = 0, l = [], f = [];
            for (t = 0; r > t; ++t)
                e = o[t],
    ...
    to.layout.histogram = function() {
        function n(n, u) {
            for (var o, a, c = [], l = n.map(e, this), f = r.call(this, l, u), s = i.call(this, f, l, u), u = -1, h = l.length, p = s.length - 1, g = t ? 1 : 1 / h; ++u < p; )
                o = c[u] = [],
                o.dx = s[u + 1] - (o.x = s[u]),
                o.y = 0;
            if (p > 0)
                for (u = -1; ++u < h; )
                    a = l[u],
                    a >= f[0] && a <= f[1] && (o = c[to.bisect(s, a, 1, p) - 1],
                    o.y += g,
                    o.push(n[u]));
            return c
        }
    ...
    to.layout.pack = function() {
        function n(n, u) {
            ...
            return wi(a, c / 2, l / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / l)),
            o
        }
        var t, e = to.layout.hierarchy().sort(di), r = 0, i = [1, 1];
    ...
    to.layout.tree = function() {
        ...
        function i(n, t, e) {
            if (t) {
                for (var r, i = n, u = n, o = t, c = i.parent.children[0], l = i.m, f = u.m, s = o.m, h = c.m; o = Ei(o),
                i = Ni(i),
                o && i; )
                    c = Ni(c),
                    u = Ei(u),
                    u.a = n,
                    r = o.z + s - i.z - l + a(o._, i._),
                    r > 0 && (Ai(zi(o, n, e), n, r),
                    l += r,
                    f += r),
                    s += o.m,
        ...
        ,
        n.size = function(t) {
            return arguments.length ? (l = null == (c = t) ? u : null,
            n) : l ? null : c
        }
        ,
        n.nodeSize = function(t) {
            return arguments.length ? (l = null == (c = t) ? null : u,
            n) : l ? c : null
        }
        ,
        Kr(n, o)
    ...
    to.layout.cluster = function() {
        function n(n, u) {
            var o, a = t.call(this, n, u), c = a[0], l = 0;
            ni(c, function(n) {
                var t = n.children;
                t && t.length ? (n.x = Li(t),
                n.y = qi(t)) : (n.x = o ? l += e(n, o) : 0,
                n.y = 0,
                o = n)
            });
            var f = Ti(c)
    ...
    to.layout.treemap = function() {
        ...
        function t(e) {
            var u = e.children;
            if (u && u.length) {
                var o, a, c, l = s(e), f = [], h = u.slice(), g = 1 / 0, v = "slice" === p ? l.dx : "dice" === p ? l.dy : "slice-dice" === p ? 1 & e.depth ? l.dy : l.dx : Math.min(l.dx, l.dy);
        ...
        function e(t) {
            var r = t.children;
            if (r && r.length) {
                var u, o = s(t), a = r.slice(), c = [];
                for (n(a, o.dx * o.dy / t.value),
                c.area = 0; u = a.pop(); )
                    c.push(u),
                    c.area += u.area,
                    null != u.z && (i(c, u.z ? o.dx : o.dy, o, !a.length),
                    c.length = c.area = 0);
                r.forEach(e)
            }
        }
        ...
        function i(n, t, e, r) {
            var i, u = -1, o = n.length, a = e.x, l = e.y, f = t ? c(n.area / t) : 0;
            if (t == e.dx) {
                for ((r || f > e.dy) && (f = e.dy); ++u < o; )
                    ...
                    i.y = l,
                    i.dy = f,
                    a += i.dx = Math.min(e.x + e.dx - a, f ? c(i.area / f) : 0);
                i.z = !0,
                i.dx += e.x + e.dx - a,
                e.y += f,
                e.dy -= f
        ...
        var o, a = to.layout.hierarchy(), c = Math.round, l = [1, 1], f = null, s = Di, h = !1, p = "squarify", g = .5 * (1 + Math.sqrt(5));
        ...
        u.padding = function(n) {
            ...
            if (!arguments.length)
                return f;
            var r;
            return s = null == (f = n) ? Di : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n],
            e) : e,
            u
        }
        ,
    ...
    to.scale.category20b = function() {
        return to.scale.ordinal().range(Sc)
    }
    ,
    to.scale.category20c = function() {
        return to.scale.ordinal().range(kc)
    }
    ;
    var _c = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(xn)
      , wc = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(xn)
      , Sc = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(xn)
      , kc = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(xn);
    ...
    to.svg.arc = function() {
        function n() {
            var n = Math.max(0, +e.apply(this, arguments))
              ...
              , f = o.apply(this, arguments) - Do
              , s = a.apply(this, arguments) - Do
              , h = Math.abs(s - f)
              , p = f > s ? 0 : 1;
            if (n > l && (g = l,
            l = n,
            n = g),
            h >= Ro)
                return t(l, p) + (n ? t(n, 1 - p) : "") + "Z";
            var g, v, d, y, m, M, x, b, _, w, S, k, N = 0, E = 0, A = [];
            if ((y = (+c.apply(this, arguments) || 0) / 2) && (d = u === Nc ? Math.sqrt(n * n + l * l) : +u.apply(this, arguments),
            p || (E *= -1),
            l && (E = tn(d / l * Math.sin(y))),
            ...
            if ((g = Math.min(Math.abs(l - n) / 2, +i.apply(this, arguments))) > .001) {
                ...
                A.push("M", m, ",", M),
                null != x && A.push("A", l, ",", l, " 0 ", C, ",", p, " ", x, ",", b),
                A.push("L", _, ",", w),
                null != S && A.push("A", n, ",", n, " 0 ", q, ",", 1 - p, " ", S, ",", k);
            return A.push("Z"),
            A.join("")
        }
        function t(n, t) {
        ...
        n.padRadius = function(t) {
            return arguments.length ? (u = t == Nc ? Nc : En(t),
            n) : u
        }
        ,
        n.startAngle = function(t) {
        ...
        n.centroid = function() {
            var n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2
              , t = (+o.apply(this, arguments) + +a.apply(this, arguments)) / 2 - Do;
    ...
    to.svg.symbol = function() {
        function n(n, r) {
            return (qc.get(t.call(this, n, r)) || Ou)(e.call(this, n, r))
        }
        var t = Hu
          , e = Fu;
    ...
    to.svg.symbolTypes = qc.keys();
    var Lc = Math.sqrt(3)
      , Tc = Math.tan(30 * Po);
    wo.transition = function(n) {
        for (var t, e, r = Rc || ++jc, i = Xu(n), u = [], o = Dc || {
            time: Date.now(),
            ease: kr,
            delay: 0,
            duration: 250
            ...
            u.push(t = []);
            for (var l = this[a], f = -1, s = l.length; ++f < s; )
                (e = l[f]) && $u(e, f, i, r, o),
                t.push(e)
        }
        return Yu(u, i, r)
    ...
    ,
    wo.interrupt = function(n) {
        return this.each(null == n ? Pc : Iu(Xu(n)))
    }
    ;
    var Rc, Dc, Pc = Iu(Xu()), Uc = [], jc = 0;
    Uc.call = wo.call,
    Uc.empty = wo.empty,
    Uc.node = wo.node,
    Uc.size = wo.size,
    to.transition = function(n, t) {
        return n && n.transition ? Rc ? n.transition(t) : n : to.selection().transition(n)
    }
    ,
    to.transition.prototype = Uc,
    Uc.select = function(n) {
        ...
        for (var a = -1, c = this.length; ++a < c; ) {
            o.push(t = []);
            for (var l = this[a], f = -1, s = l.length; ++f < s; )
                (r = l[f]) && (e = n.call(r, r.__data__, f, a)) ? ("__data__"in r && (e.__data__ = r.__data__),
                $u(e, f, u, i, r[u][i]),
    ...
    Uc.filter = function(n) {
        ...
        for (var u = 0, o = this.length; o > u; u++) {
            i.push(t = []);
            for (var e = this[u], a = 0, c = e.length; c > a; a++)
                (r = e[a]) && n.call(r, r.__data__, a, u) && t.push(r)
        }
    ...
    Uc.ease = function(n) {
        var t = this.id
          , e = this.namespace;
        return arguments.length < 1 ? this.node()[e][t].ease : ("function" != typeof n && (n = to.ease.apply(to, arguments)),
        Y(this, function(r) {
            r[e][t].ease = n
        }))
    }
    ...
    Uc.transition = function() {
        for (var n, t, e, r, i = this.id, u = ++jc, o = this.namespace, a = [], c = 0, l = this.length; l > c; c++) {
            a.push(n = []);
            for (var t = this[c], f = 0, s = t.length; s > f; f++)
                (e = t[f]) && (r = e[o][i],
                $u(e, f, o, u, {
                    time: r.time,
                    ease: r.ease,
    ...
    to.svg.axis = function() {
        function n(n) {
            n.each(function() {
                var n, l = to.select(this), f = this.__chart__ || e, s = this.__chart__ = e.copy(), h = null == c ? s.ticks ? s.ticks.apply(s, a) : s.domain() : c, p = null == t ? s.tickFormat ? s.tickFormat.apply(s, a) : m : t, g = l.selectAll(".tick").data(h, s), v = g.enter().insert("g", ".domain").attr("class", "tick").style("opacity", zo), d = to.transition(g.exit()).style("opacity", zo).remove(), y = to.transition(g.order()).style("opacity", 1), M = Math.max(i, 0) + o, x = ji(s), b = l.selectAll(".domain").data([0]), _ = (b.enter().append("path").attr("class", "domain"),
                to.transition(b));
                v.append("line"),
                v.append("text");
                var w, S, k, N, E = v.select("line"), A = y.select("line"), C = g.select("text").text(p), z = v.select("text"), q = y.select("text"), L = "top" === r || "left" === r ? -1 : 1;
                if ("bottom" === r || "top" === r ? (n = Bu,
                w = "x",
                k = "y",
                S = "x2",
                N = "y2",
                C.attr("dy", 0 > L ? "0em" : ".71em").style("text-anchor", "middle"),
                _.attr("d", "M" + x[0] + "," + L * u + "V0H" + x[1] + "V" + L * u)) : (n = Wu,
                w = "y",
                k = "x",
                S = "y2",
                N = "x2",
                C.attr("dy", ".32em").style("text-anchor", 0 > L ? "end" : "start"),
                _.attr("d", "M" + L * u + "," + x[0] + "H0V" + x[1] + "H" + L * u)),
                E.attr(N, L * i),
                z.attr(k, L * M),
        ...
        var t, e = to.scale.linear(), r = Fc, i = 6, u = 6, o = 3, a = [10], c = null;
        ...
        ,
        n.orient = function(t) {
            return arguments.length ? (r = t in Hc ? t + "" : Fc,
            n) : r
        }
        ,
        n.ticks = function() {
    ...
    to.svg.brush = function() {
        function n(t) {
            t.each(function() {
                ...
                var c, s = to.transition(t), h = to.transition(o);
                l && (c = ji(l),
        ...
        function u() {
            ...
            function v() {
                32 == to.event.keyCode && 2 == C && (q[0] += s[1],
                q[1] += h[1],
                C = 0,
                S())
            }
            function d() {
                ...
                x && (n[0] += x[0],
                n[1] += x[1]),
                C || (to.event.altKey ? (M || (M = [(s[0] + s[1]) / 2, (h[0] + h[1]) / 2]),
                q[0] = s[+(n[0] < M[0])],
            ...
            function y(n, t, e) {
                var r, i, u = ji(t), c = u[0], l = u[1], f = q[e], v = e ? h : s, d = v[1] - v[0];
                return C && (c -= f,
                l -= d + f),
                r = (e ? g : p) ? Math.max(c, Math.min(l, n[e])) : n[e],
                C ? i = (r += f) + d : (M && (f = Math.max(c, Math.min(l, 2 * M[e] - r))),
                r > f ? (i = r,
                r = f) : i = f),
            ...
            var M, x, b = this, _ = to.select(to.event.target), w = c.of(b, arguments), k = to.select(b), N = _.datum(), E = !/^(n|s)$/.test(N) && l, A = !/^(e|w)$/.test(N) && f, C = _.classed("extent"), z = W(b), q = to.mouse(b), L = to.select(t(b)).on("keydown.brush", u).on("keyup.brush", v);
            if (to.event.changedTouches ? L.on("touchmove.brush", d).on("touchend.brush", m) : L.on("mousemove.brush", d).on("mouseup.brush", m),
            ...
            C)
                ...
                var T = +/w$/.test(N)
                  , R = +/^n/.test(N);
                x = [s[1 - T] - q[0], h[1 - R] - q[1]],
                q[0] = s[T],
                q[1] = h[R]
            } else
                to.event.altKey && (M = q.slice());
            k.style("pointer-events", "none").selectAll(".resize").style("display", null),
            to.select("body").style("cursor", _.style("cursor")),
            w({
                type: "brushstart"
            }),
            d()
        }
        var o, a, c = N(n, "brushstart", "brush", "brushend"), l = null, f = null, s = [0, 0], h = [0, 0], p = !0, g = !0, v = Ic[0];
        return n.event = function(n) {
            n.each(function() {
                var n = c.of(this, arguments)
                  ...
                  , e = this.__chart__ || t;
                this.__chart__ = t,
                Rc ? to.select(this).transition().each("start.brush", function() {
                    o = e.i,
                    a = e.j,
                    s = e.x,
                    h = e.y,
        ...
        ,
        n.clamp = function(t) {
            return arguments.length ? (l && f ? (p = !!t[0],
            g = !!t[1]) : l ? p = !!t : f && (g = !!t),
            n) : l && f ? [p, g] : l ? p : f ? g : null
        }
        ,
        n.extent = function(t) {
            var e, r, i, u, c;
    ...
    var Oc = {
      ...
      , Ic = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []]
      , Yc = ca.format = ga.timeFormat
      , Zc = Yc.utc
      , Vc = Zc("%Y-%m-%dT%H:%M:%S.%LZ");
    Yc.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Ju : Vc,
    Ju.parse = function(n) {
        var t = new Date(n);
        return isNaN(t) ? null : t
    }
    ,
    Ju.toString = Vc.toString,
    ca.second = Hn(function(n) {
        return new la(1e3 * Math.floor(n / 1e3))
    }, function(n, t) {
        n.setTime(n.getTime() + 1e3 * Math.floor(t))
    }, function(n) {
        return n.getSeconds()
    }),
    ca.seconds = ca.second.range,
    ca.seconds.utc = ca.second.utc.range,
    ca.minute = Hn(function(n) {
        return new la(6e4 * Math.floor(n / 6e4))
    }, function(n, t) {
        n.setTime(n.getTime() + 6e4 * Math.floor(t))
    }, function(n) {
        return n.getMinutes()
    }),
    ca.minutes = ca.minute.range,
    ca.minutes.utc = ca.minute.utc.range,
    ca.hour = Hn(function(n) {
        var t = n.getTimezoneOffset() / 60;
        return new la(36e5 * (Math.floor(n / 36e5 - t) + t))
    }, function(n, t) {
        n.setTime(n.getTime() + 36e5 * Math.floor(t))
    }, function(n) {
        return n.getHours()
    }),
    ca.hours = ca.hour.range,
    ca.hours.utc = ca.hour.utc.range,
    ca.month = Hn(function(n) {
        return n = ca.day(n),
        n.setDate(1),
        n
    }, function(n, t) {
    ...
    ca.months = ca.month.range,
    ca.months.utc = ca.month.utc.range;
    var Xc = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6]
      , $c = [[ca.second, 1], [ca.second, 5], [ca.second, 15], [ca.second, 30], [ca.minute, 1], [ca.minute, 5], [ca.minute, 15], [ca.minute, 30], [ca.hour, 1], [ca.hour, 3], [ca.hour, 6], [ca.hour, 12], [ca.day, 1], [ca.day, 2], [ca.week, 1], [ca.month, 1], [ca.month, 3], [ca.year, 1]]
      , Bc = Yc.multi([[".%L", function(n) {
    ...
    $c.year = ca.year,
    ca.scale = function() {
        return Gu(to.scale.linear(), $c, Bc)
    }
    ;
    var Jc = $c.map(function(n) {
        return [n[0].utc, n[1]]
    })
      , Gc = Zc.multi([[".%L", function(n) {
    ...
    Jc.year = ca.year.utc,
    ca.scale.utc = function() {
        return Gu(to.scale.linear(), Jc, Gc)
    }
    ,
    ...
    "function" == typeof define && define.amd ? define(to) : "object" == typeof module && module.exports && (module.exports = to),
    this.d3 = to
}();
