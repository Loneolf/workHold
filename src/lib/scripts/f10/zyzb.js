...
const gettyField = function(grid,data,year,oTjKong){
	return {"_a0":{"name":"关键指标","type":"title","value":"--"},
			...
			"_a14":{"name":"存货周转率","formatType":"3","value":tjKongFun(grid[data.K_12INDEX],"_a14",year,oTjKong)},
			...
			"_a24":{"name":"成长能力","type":"title","value":"--"},
			"_a25":{"name":"营业收入同比增长率","formatType":"1","value":tjKongFun(grid[data.K_19INDEX],"_a25",year,oTjKong)},
			"_a26":{"name":"净利润同比增长率","formatType":"1","value":tjKongFun(grid[data.K_20INDEX],"_a26",year,oTjKong)},
	}
}
