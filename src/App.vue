<template>
  <div class="appbox" id="app">
    <!-- <ul class="nav">
      ...
      <div> <router-link to="/jkf10">jkf10</router-link> </div>
    </ul> -->
    <ul class="nav">
      <div @click="routerClick('/home')">home</div>
      <div @click="routerClick('/about')">about</div>
      <div @click="routerClick('/jkf10')">jkf10</div>
    </ul>
