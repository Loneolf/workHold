<template>
    <!-- 港股 -->
    <div :class="isggtjy">
        <div class="sale" @click="htradeaction('12320')"><span>卖出</span></div>
        <!--<div class="sale" @click="tradeaction('16011')"><em></em><span>港股卖出</span></div>-->
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            htradeaction(action) {
                ...
                this.$TZT.action10061('/deal/hstock?hstockcode=' + this.stockcode);
            },
            gzclick(index) {
                localService.saveMapMesg({'footerStockcode': this.stockcode});
...
<style lang="less" scoped>
    ...
    .buy em {
        background: url('../../../assets/hq-icon/mairu.png') no-repeat 50%;
    ...
    .sale em {
        background: url('../../../assets/hq-icon/maichu.png') no-repeat 50%;
        background-size: 30px 28px;
    }

    .chedan em {
        background: url('../../../assets/jy/images/nav_3.png') no-repeat 50%;
