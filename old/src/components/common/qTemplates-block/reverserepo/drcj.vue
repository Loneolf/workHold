  ...
  <div class="cont_list" v-for='item in grid0' @click="listFunc($index)">
    ...
    <div class="list_con">
      <div class="w60 position">
        <p class="w50 pt15"><em class="con_title center {{item.buyDirectionColor}}">{{item.buyDirection}}</em><em class="cont_time center">{{item.reporeTime | dateForm INDEXKEY.ORDERDATEINDEX}}</em></p>
