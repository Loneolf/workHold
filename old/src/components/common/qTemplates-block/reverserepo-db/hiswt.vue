...
//              console.log(listObj);
                ...
                listObj.ordeTime = util.dateForm(listObj.ORDERTIMEINDEX,oData.ORDERTIMEINDEX,oData.DATEFORMINDEX);//委托时间
                listObj.orderPrice = listObj.ORDERPRICEINDEX;//委托价格
                listObj.orderQty = util.toDecimal2(listObj.ORDERQTYINDEX,0);//委托数量
