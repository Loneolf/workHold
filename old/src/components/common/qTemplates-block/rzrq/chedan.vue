...
<script>
  ...
  import service_rzrq from '../../../deal/service/trade/service_rzrq'
  ...
  import util from '../../../../util/util'
	export default{
        ...
        gridData:[],
        loading:false,
        INDEX: ['STOCKCODEINDEX','STOCKNAMEINDEX','ENTRUSTTYPENAMEINDEX','ORDERPRICEINDEX','ORDERQTYINDEX','ORDERTIMEINDEX','MATCHPRICEINDEX','MATCHQTYINDEX','DRAWINDEX','BUYDIRECTIONINDEX','BUSINESSNAMEINDEX','CONTACTINDEX'],
        INDEXKEY:{},
        listNumber:0,
        S_FIELD:'',
        A_ARR:[],
    ...
    methods: {
      ...
      loadMore () {
        ...
        service_rzrq.require404(oSendData)
          .then((data)=>{
            console.log(data);
            $.hidePreloader();
            var ArrayData = [];
