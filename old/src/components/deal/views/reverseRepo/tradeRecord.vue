...
export default {
  ...
  attached(){
  	 ...
  	 this.wtmoney = this.$route.query.wtmoney;
  	 this.stockcode = this.$route.query.stockcode;
  	 this.wtaccount = this.$route.query.wtaccount;
  	 this.wtaccounttype = this.$route.query.wtaccounttype;
  	 this.gzname = this.$route.query.gzmc;

  	// alert(this.stockcodes);
    this.getCustomers(1);
  },
  methods:{
    ...
    getCustomers(num){
       var num = num || '0';
        $('.proess [data-num]').each(function (i, t) {
           ...
           this.total = this.wtmoney;
          // alert(this.total)
          this.money = tradingconfig.fmoney(this.wtmoney,2);
         // this.total = field[4]*100;
          this.gzmc = decodeURIComponent(this.gzname);
          this.gzdm = this.stockcode;
          this.wtjg = this.price;
          this.day = repoconfig.repoData[this.stockcode];
          this.WTACCOUNT = this.wtaccount;
          this.WTACCOUNTTYPEINDEX = this.wtaccounttype;
          this.CONTACTINDEX = this.answerid;
          var next = tradingconfig.nextTradeDate(utils.getYTDS(utils.manyDays(repoconfig.repoData[this.stockcode])));
           this.getkydate();
          console.log(this.ky);
           this.getDay();
