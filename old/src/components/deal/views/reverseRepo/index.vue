<template>
  <div class="content">
    ...
    <div class="list">
      <p @click="clickdata(0)"><span class="listImg listOut"></span><span>撤单</span></p><p @click="clickdata(1)"><span class="listImg listQuery"></span><span>查询</span></p><p @click="clickdata(2)"><span class="listImg listIntroduce"></span><span>产品介绍</span></p><!-- <p @click="clickdata(3)"><span class="listImg listHelp"></span><span>交易帮助</span></p> --><p @click="clickdata(5)"><span class="listImg listHelp"></span><span>查询持仓</span></p>
    </div>
