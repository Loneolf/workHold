<template>
  <div class="explain content native-scroll">
    <div class="buttons-tab fixed-tab buttons-fixed" data-offset="44">
      <a href="#tab1" class="tab-link button active"><span class="active">撤单</span></a>
      <a href="#tab2" class="tab-link button"><span class="">查询</span></a>
    </div>
    <div class="tabs">
      ...
      <div id="tab2" class="tab">
        ...
        <div class="list-p">
          <p @click="clickdata(2)"><span>历史成交</span><i></i></p>
          <p @click="clickdata(3)"><span>历史委托</span><i></i></p>
        </div>
      </div>
    </div>
</template>
