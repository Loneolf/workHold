<template>
  <div class="adBox1" style="width: 100%;height: 145px; position: relative;">
    <swipe class="my-swipe" :speed="500" :auto="0" :show-indicators="true" :no-drag="true" >
      <swipe-item class="slide1">
        <div class="cnyName">
          <div class="cnyName_tige">
            <i class="china"></i><span>人民币账户CNY</span>
          </div>
          <div class="moerysp">
            <ul class="moerysp_ul clear">
              ...
              <li>
                <span class="j_ylrmb {{ylrmb>0?'rise':ylrmb<0?'fill':''}}">{{ylrmb}}</span>
                <p>总盈利</p>
              </li>
              <li>
      ...
      <swipe-item class="slide1" v-show="isUSD">
        <div class="cnyName">
          <div class="cnyName_tige">
            <i class="usd"></i><span>美元账户USD</span>
          </div>
          <div class="moerysp">
            <ul class="moerysp_ul clear">
              <li>
                <span class="j_totalmy">{{totalmy}}</span>
                <p>总资产</p>
              </li>
              <li>
                <span class="j_ylmy {{ylmy>0?'rise':ylmy<0?'fill':''}}">{{ylmy}}</span>
                <p>总盈利</p>
              </li>
              <li>
                <span class="j_szmy">{{szmy}}</span>
                <p>总市值</p>
              </li>
            </ul>
          </div>
          <div class="moerysp moerysp2">
            <ul class="moerysp_ul clear">
              <li>
                <span class="j_kqmy">{{kqmy}}</span>
                <p>可取</p>
              </li>
              <li>
                <span class="j_kymy">{{kymy}}</span>
                <p>可用</p>
              </li>
              <li>
                <div class="band_over j_yzzz" @click="action10061('/jy/dcgyh/dcg_index2.0.html')">
      ...
      <swipe-item class="slide1" v-show="isHK">
        <div class="cnyName">
          <div class="cnyName_tige">
            <i class="hk"></i><span>港币账户HK</span>
          </div>
          <div class="moerysp">
            <ul class="moerysp_ul clear">
              <li>
                <span class="j_totalgb">{{totalgb}}</span>
                <p>总资产</p>
              </li>
              <li>
                <span class="j_ylgb {{ylgb>0?'rise':ylgb<0?'fill':''}}">{{ylgb}}</span>
                <p>总盈利</p>
              </li>
              <li>
                <span class="j_szgb">{{szgb}}</span>
                <p>总市值</p>
              </li>
            </ul>
          </div>
          <div class="moerysp moerysp2">
            <ul class="moerysp_ul clear">
              <li>
                <span class="j_kqgb">{{kqgb}}</span>
                <p>可取</p>
              </li>
              <li>
                <span class="j_kygb">{{kygb}}</span>
                <p>可用</p>
              </li>
              <li>
                <div class="band_over j_yzzz" @click="action10061('/jy/dcgyh/dcg_index2.0.html')">
  ...
  <div class="explain content native-scroll">
    <div class="wrancont">
      <templates url="ptjy/holding_chicang"></templates>
    </div>
  </div>
...
<style lang="less" scoped>
  ...
  .usd{
    width: 16px;
    height: 12px;
    background: url('../../../../../assets/jy/images/jy-chicang.png') -29px -4px no-repeat;
    background-size: 50px 40px;
    display: block;
    float: left;
    margin-top: 3px;
  ...
  .hk{
    width: 16px;
    height: 12px;
    background: url('../../../../../assets/jy/images/jy-chicang.png') -4px -20px no-repeat;
    background-size: 50px 40px;
    display: block;
    float: left;
    margin-top: 3px;
